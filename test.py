...
def main():
    ...
    if sys.argv[1] is None:
        print('用户名参数呢?[python icourse163.py username password url]')
        sys.exit(1)
    if sys.argv[2] is None:
        print('密码参数呢？[python icourse163.py username password url]')
        sys.exit(1)
    if sys.argv[3] is None:
        print('链接参数呢？[python icourse163.py username password url]')
        sys.exit(1)
